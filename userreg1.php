   ...
   // $salt = random_bytes(16); 
    ...
    if (!preg_match('/^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$/', $email)) {
        ...
        if (mysqli_num_rows($select) > 0 ||mysqli_num_rows($selecta) > 0) {
            echo '<div id="error-message" style="display:none; color:red;">Ce email est déja utiliser</div>';
        } 
            ...
            $insert = mysqli_query($conn, "INSERT INTO `users2`(full_name, email,password, number, wilaya,communes,pp,verify_token) VALUES('$name', '$email', '$hashedPassword','$num','$wilayas','$communes','$new_img_name','$verify_token')")
